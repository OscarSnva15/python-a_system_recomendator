...
class data_business_filter:
    ...
    def __get_bussines_neighborhood_acc(self):
        ...
        self.influence_radio_2 = float(self.intradistances_target_bussines.mode().mean())
        self.influence_radio = float(self.intradistances_target_bussines.mean())
    ...
    def report_accumulated_bussines_support(self):
        ...
        dfExcel = pd.DataFrame(columns = ['snapTime', 'code_bussines', 'radio', 'nameBussines', '461110', '465311', '812110', '463211', '722513', '461122', '461160', '722514', '461130', '311812', '467111', '311830', '722517', '467115', '561432', '722518', '464111', '461121', '811111', '722519', '722515', '621211', '332320', '461190', '465912', '466410', '713120', '531113', '811121', '813210', '468211', '461150', '811191', '463310', '713943', '321910', '465111', '722511', '467114', '466312', '611111', '812210', '621111', '461170', '811192', '811112', '461140', '312112', '465211', '811499', '811430', '466212', '461213', '811410', '464113', '722412', '466111', '434211', '434311', '611112', '434112', '463113', '462112', '464112', '811119', '463215', '811211', '541920', '541110', '323119', '467113', '811492', '337120', '812410', '463213', '813230', '931610', '468112', '811219', '811420', '541941', '311520', '722512', '621398', '311910', '812130', '621511', '532282', '611621', '468420' ], index=range(len(self.filter_bussines)))
        ...
        for i, base in self.filter_bussines.iterrows():
            ...
            for _, iter in self.df_complete.iterrows():
                if iter['Código_de_la_clase_de_actividad_SCIAN'] in types_code.keys():
                    ...
                    if 0 < sqrt(dlat**2 + dlong**2) < self.influence_radio:
            ...
            temp = [ self.epoch, self.filter_bussines.iloc[0]['Código_de_la_clase_de_actividad_SCIAN'], self.influence_radio, str(base['Nombre_de_la_Unidad_Económica']) ]
            temp.extend( code )
            dfExcel.iloc[posicion] = tuple( temp )
            posicion = posicion + 1
        
        averageList = [ self.epoch, self.filter_bussines.iloc[0]['Código_de_la_clase_de_actividad_SCIAN'], self.influence_radio, str(base['Nombre_de_clase_de_la_actividad']) ]


        ListColumns  = []
        #we obtain average for each columns
        ListColumns = dfExcel.columns
        for i, x in enumerate(ListColumns):
            if x not in ['snapTime', 'code_bussines','radio', 'nameBussines']:
                # averageList.append( dfExcel[x].mean() )
                averageList.append( dfExcel[x].astype(bool).sum() / len(self.filter_bussines) )
        ...
        # averageList # [ 10 if x > self.cutoff*0.75 else 0 for x in averageList ]
        # VCDL.insert(0,self.code_bussines)
        # VCDL.insert(2,self.filter_bussines.iloc[0]["Nombre_de_clase_de_la_actividad"])
...
def generate_descriptors_for_business( ):
    ...
    # list_codes.reverse()
    dfExcel_VDC = pd.DataFrame(columns = ['snapTime', 'code_bussines', 'radio', 'nameBussines', '461110', '465311', '812110', '463211', '722513', '461122', '461160', '722514', '461130', '311812', '467111', '311830', '722517', '467115', '561432', '722518', '464111', '461121', '811111', '722519', '722515', '621211', '332320', '461190', '465912', '466410', '713120', '531113', '811121', '813210', '468211', '461150', '811191', '463310', '713943', '321910', '465111', '722511', '467114', '466312', '611111', '812210', '621111', '461170', '811192', '811112', '461140', '312112', '465211', '811499', '811430', '466212', '461213', '811410', '464113', '722412', '466111', '434211', '434311', '611112', '434112', '463113', '462112', '464112', '811119', '463215', '811211', '541920', '541110', '323119', '467113', '811492', '337120', '812410', '463213', '813230', '931610', '468112', '811219', '811420', '541941', '311520', '722512', '621398', '311910', '812130', '621511', '532282', '611621', '468420' ])
    ...
    for code in list_codes:
        ...
        writer_test = pd.ExcelWriter('../querys/dataExceLCreated/descriptors_RatioOriginal_VCDL.xlsx', engine='xlsxwriter')
